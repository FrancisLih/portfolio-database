...
const WorksTable = ({isLoading, isFetching, works, setItemEdit}) => {
  ...
  return (
   ...
   {isFetching && <SpinnerFetching/>}
    ...
    {store.isActive && <ModalConfirm position="center" queryKey="works" endpoint={`/v1/works/active/${id}`} isArchiving={isArchiving}/>}
    {store.isDelete && <ModalDelete position="center" queryKey="works" endpoint={`/v1/works/${id}`} />}
    </>
  )
}
