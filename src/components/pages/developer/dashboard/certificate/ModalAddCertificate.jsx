              ...
              <Formik
                       ...
                       onSubmit={async (values) => {
                        ...
                        mutation.mutate({...values, 
                            certificate_image:
                            (itemEdit && itemEdit.certificate_image === "") || photo
                              ? photo === null
                                ? itemEdit.certificate_image
                                : photo.name
                  ...
                  >
                      ...
                      <div className="input-wrap">
                                        ...
                                        {photo || (itemEdit && itemEdit.certificate_image !== "") ? (
                                        <img
                                        src={
                                        photo
                                        ? URL.createObjectURL(photo) // preview
                                        : itemEdit.certificate_image // check db
                                        ? devBaseImgUrl + "/" + itemEdit.certificate_image
                                        : null
                                        }
                                        alt="Photo"
